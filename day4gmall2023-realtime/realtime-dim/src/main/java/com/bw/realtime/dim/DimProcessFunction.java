...
public class DimProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDim, Tuple2<JSONObject,TableProcessDim>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDim> tableProcessDims = JdbcUtil.queryList(mysqlConnection, "select * from realtime.table_process_dim", TableProcessDim.class, true);
